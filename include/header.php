            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="top-contact list-text-white d-table">
                        <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+8801647185767</a></li>
                        <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>pritam.221002115@gmail.com</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <?php if(isset($_SESSION['uemail'])) { 
                                    if($_SESSION['utype'] == 'user') { ?>
                                        <!-- Show Favourites link for user -->
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">My Account</a>
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a class="nav-link" href="profile.php">Profile</a></li>
                                                <li class="nav-item"><a class="nav-link" href="add_to_favorites.php">Your Favourites</a></li>
                                                <li class="nav-item"><a class="nav-link" href="calc.php">EMI Calculator</a></li>
                                                <li class="nav-item"><a class="nav-link" href="logout.php">Logout</a></li>
                                            </ul>
                                        </li>
                                    <?php } elseif($_SESSION['utype'] == 'agent') { ?>
                                        <!-- Show Your Property link for agent -->
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">My Account</a>
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a class="nav-link" href="profile.php">Profile</a></li>
                            ...
                            if (isset($_SESSION['uemail']) && $_SESSION['utype'] == 'agent') { ?>
